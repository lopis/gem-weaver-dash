...
export const sprites: SpriteRegistry = [
  ...
  ['FR', // STRAWBERRY
    red2, "M 52 17 C 63 28 64 53 59 59 C 53 64 29 63 17 51 C 8 43 12 30 21 21 C 30 12 43 8 52 17",
    green2, "M 36 2 C 36 2 30 6 26 10 C 22 7 18 4 18 4 C 18 4 17 12 17 17 C 11 17 4 18 4 18 C 4 18 7 22 10 26 C 6 30 2 36 2 36 C 2 36 15 39 19 38 C 22 37 24 33 23 29 C 24 29 24 28 24 27 C 25 27 25 26 25 25 C 26 25 27 25 27 25 C 28 24 29 24 29 23 C 33 24 36 22 38 19 C 39 15 36 2 36 2 z"
  ],
  ['FY', // BANANA
    yellow, "M 7 54 C 5 54 1 54 1 51 C 0 48 4 48 6 47 C 17 46 28 44 37 38 c 5 -4 9 -8 11 -14 c 2 -4 3 -9 2 -14 c 1 -2 4 -3 6 -2 c 2 2 4 4 3 7 c -1 11 -4 22 -12 29 c -4 5 -11 7 -17 8 c -7 1 -15 2 -23 2 z",
    yellow2, "M 53 1 C 50 0 45 2 48 6 C 50 8 49 12 52 10 C 56 11 56 7 55 5 C 54 3 56 1 53 1 Z M 58 12 c 1 5 -1 9 -2 14 C 53 36 46 45 36 49 C 25 54 13 55 2 52 C 1 54 5 58 7 59 C 14 64 24 65 32 62 C 46 58 59 47 63 33 c 2 -6 1 -14 -3 -19 c 0 -1 -1 -1 -1 -2 z"
  ],
  ['FB', // BLUEBERRY
